...
import ru.rifnur.tasktracker.api.v2.requests.IRequestStrategy


val TaskRequestSerializer = RequestSerializer(TaskRequestSerializerBase)

private object TaskRequestSerializerBase : JsonContentPolymorphicSerializer<IRequest>(IRequest::class) {
