...
interface ConsumerStrategy {
    ...
    fun serialize(source: ComTaskContext): String
    fun deserialize(value: String, target: ComTaskContext)
}

class AppKafkaConsumer(
    private val config: AppKafkaConfig,
    consumerStrategies: List<ConsumerStrategy>,
    private val processor: ComTaskProcessor = ComTaskProcessor(),
    ...
    private fun sendResponse(context: ComTaskContext, strategy: ConsumerStrategy, outputTopic: String) {
